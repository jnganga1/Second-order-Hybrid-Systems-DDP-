function [xbar, ybar, ubar] = initial_guess(xbar, ubar, robot_params, params,DynFns)
P = params.P;
...
%             [xk_next,yk] = get_dynamics(xk, uk, P(mode_ind),'cont',params,DynFns);
            ...
            %[xk_next,yk] = get_dynamics(xk, uk, P(mode_ind),'reset',params,DynFns);
